                        ...
                        MAT_VAL_TYPE *y_golden)
{
    ...
    INFO_LOG("  CUDA SpMV runtime %4.2f ms, %4.2f GFlops\n\n", time_cuda_spmv_base, gflops);
    printf("%u,%u,%u,%d,%d,%d,%4.2f,%4.2f,", sizeof(MAT_VAL_TYPE), sizeof(MAT_VAL_TYPE), sizeof(MAT_VAL_TYPE),rowA,colA,nnzA,time_cuda_spmv_base, gflops);
    printf("%lf\n", mwatt);
