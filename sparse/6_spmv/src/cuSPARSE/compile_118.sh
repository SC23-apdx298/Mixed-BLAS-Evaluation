...
# /usr/local/cuda-11.8/bin/nvcc spmv_csr.cu -o ./bin/exe_spmv_cusparse_8_32_32I $DEFINE -lcudart -lcusparse -arch=sm_89 -w -I../../include -lnvidia-ml -lpthread
...
/usr/local/cuda-11.8/bin/nvcc spmv_csr.cu -o ./bin/exe_spmv_cusparse_8_32_32 $DEFINE -lcudart -lcusparse -arch=sm_89 -w -I../../include -lnvidia-ml -lpthread
...
# /usr/local/cuda-11.8/bin/nvcc spmv_csr.cu -o ./bin/exe_spmv_cusparse_16_32_32 $DEFINE -lcudart -lcusparse -arch=sm_89 -w -I../../include -lnvidia-ml -lpthread
...
/usr/local/cuda-11.8/bin/nvcc spmv_csr.cu -o ./bin/exe_spmv_cusparse_16BF_32_32 $DEFINE -lcudart -lcusparse -arch=sm_89 -w -I../../include -lnvidia-ml -lpthread
...
# /usr/local/cuda-11.8/bin/nvcc spmv_csr.cu -o ./bin/exe_spmv_cusparse_16_16_32 $DEFINE -lcudart -lcusparse -arch=sm_89 -w -I../../include -lnvidia-ml -lpthread
...
# /usr/local/cuda-11.8/bin/nvcc spmv_csr.cu -o ./bin/exe_spmv_cusparse_16BF_16BF_32 $DEFINE -lcudart -lcusparse -arch=sm_89 -w -I../../include -lnvidia-ml -lpthread
...
/usr/local/cuda-11.8/bin/nvcc spmv_csr.cu -o ./bin/exe_spmv_cusparse_32F $DEFINE -lcudart -lcusparse -arch=sm_89 -w -I../../include -lnvidia-ml -lpthread
...
/usr/local/cuda-11.8/bin/nvcc spmv_csr.cu -o ./bin/exe_spmv_cusparse_64F $DEFINE -lcudart -lcusparse -arch=sm_89 -w -I../../include -lnvidia-ml -lpthread
